...
namespace LivroCaixa.Extensions
{
    public static class HtmlExtensions
    {
        ...
        private static string GetValueFromModelValue(object formValue)
        {
            ...
            //comentei esta parte para funcionar, já que não usarei valores binários...(Danilo 24/05/2022)
            //Binary binaryValue = formValue as System.Buffers.Binary;
            //if (binaryValue != null)
            //{
